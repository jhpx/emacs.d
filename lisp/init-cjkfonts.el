...
(defun qiang-set-font (english-fonts
  ...
  (save-excursion
    (with-current-buffer (find-file-noselect "~/emacs-font-size")
...
(defvar bhj-english-fonts '("DejaVu Sans Mono" "Monaco" "Consolas" "Monospace" "Courier New"))
(defvar bhj-chinese-fonts '("Microsoft Yahei" "Microsoft_Yahei" "微软雅黑" "文泉驿等宽微米黑" "宋体" "新宋体" "黑体"))

(qiang-set-font
 bhj-english-fonts
 (if (file-exists-p "~/.emacs-font-size")
     (save-excursion
       (find-file "~/.emacs-font-size")
       (goto-char (point-min))
